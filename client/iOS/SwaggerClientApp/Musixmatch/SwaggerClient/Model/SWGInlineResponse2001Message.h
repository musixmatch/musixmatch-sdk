...
@protocol SWGInlineResponse2001Message
@end

@interface SWGInlineResponse2001Message : SWGObject


@property(nonatomic) SWGInlineResponse2001MessageHeader* header;

@property(nonatomic) SWGInlineResponse2001MessageBody* body;
