...
@protocol SWGInlineResponse2006MessageBody
@end

@interface SWGInlineResponse2006MessageBody : SWGObject

/* A list of tracks [optional]
 */
@property(nonatomic) NSArray<SWGInlineResponse2006MessageBodyTrackList>* trackList;
