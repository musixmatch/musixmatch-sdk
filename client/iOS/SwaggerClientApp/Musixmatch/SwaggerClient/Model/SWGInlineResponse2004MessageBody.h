...
@protocol SWGInlineResponse2004MessageBody
@end

@interface SWGInlineResponse2004MessageBody : SWGObject

/* A list of artists [optional]
 */
@property(nonatomic) NSArray<SWGInlineResponse2003MessageBody>* artistList;
