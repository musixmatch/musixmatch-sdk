...
@protocol SWGInlineResponse2002Message
@end

@interface SWGInlineResponse2002Message : SWGObject


@property(nonatomic) SWGInlineResponse2002MessageHeader* header;

@property(nonatomic) SWGInlineResponse2002MessageBody* body;
