...
@protocol SWGInlineResponse2006Message
@end

@interface SWGInlineResponse2006Message : SWGObject


@property(nonatomic) SWGInlineResponse2005MessageHeader* header;

@property(nonatomic) SWGInlineResponse2006MessageBody* body;
