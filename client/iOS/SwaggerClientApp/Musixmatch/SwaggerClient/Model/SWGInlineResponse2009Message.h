...
@protocol SWGInlineResponse2009Message
@end

@interface SWGInlineResponse2009Message : SWGObject


@property(nonatomic) SWGInlineResponse200MessageHeader* header;

@property(nonatomic) SWGInlineResponse2006MessageBodyTrackList* body;
