...
@protocol SWGInlineResponse2002MessageBody
@end

@interface SWGInlineResponse2002MessageBody : SWGObject

/* A list of albums [optional]
 */
@property(nonatomic) NSArray<SWGInlineResponse200MessageBody>* albumList;
