...
@protocol SWGTrackSecondaryGenresMusicGenre
@end

@interface SWGTrackSecondaryGenresMusicGenre : SWGObject

/*  [optional]
 */
@property(nonatomic) NSString* musicGenreVanity;
/*  [optional]
 */
@property(nonatomic) NSString* musicGenreNameExtended;
/*  [optional]
 */
@property(nonatomic) NSNumber* musicGenreParentId;
/*  [optional]
 */
@property(nonatomic) NSString* musicGenreName;
/*  [optional]
 */
@property(nonatomic) NSNumber* musicGenreId;
