...
@interface SWGSubtitleApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGSubtitleApi

NSString* kSWGSubtitleApiErrorDomain = @"SWGSubtitleApiErrorDomain";
NSInteger kSWGSubtitleApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGSubtitleApi *sharedAPI;
...
-(NSNumber*) matcherSubtitleGetGetWithFormat: (NSString*) format
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/matcher.subtitle.get"];
    ...
    if (fSubtitleLength != nil) {
        queryParams[@"f_subtitle_length"] = fSubtitleLength;
    }
    if (fSubtitleLengthMaxDeviation != nil) {
        queryParams[@"f_subtitle_length_max_deviation"] = fSubtitleLengthMaxDeviation;
    }
...
-(NSNumber*) trackSubtitleGetGetWithTrackId: (NSString*) trackId
    ...
    if (trackId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGSubtitleApiErrorDomain code:kSWGSubtitleApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/track.subtitle.get"];
