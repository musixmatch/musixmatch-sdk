...
@interface SWGSubtitleApi: NSObject <SWGApi>

extern NSString* kSWGSubtitleApiErrorDomain;
extern NSInteger kSWGSubtitleApiMissingParamErrorCode;
...
/// 
///  code:200 message:"The request was successful."
///
