...
-(NSNumber*) requestWithPath: (NSString*) path
    ...
    if ([responseContentType isEqualToString:@"application/json"]) {
        ...
        // @see http://stackoverflow.com/questions/20807926/afnetworking-2-0-unacceptable-content-type-text-plain
        NSMutableSet *acceptableContentTypes = [NSMutableSet setWithSet:self.responseSerializer.acceptableContentTypes];
        [acceptableContentTypes addObject:@"text/plain"]; // OL sends text/plain in any case
